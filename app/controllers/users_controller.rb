class UsersController < ApplicationController
  def index
    ...
    @users = @q.result(:distinct => true).includes(:listings, :sent_messages, :received_messages, :reviews, :userreviews, :bookmarks, :requests, :bookingreviews).page(params[:page]).per(10)
